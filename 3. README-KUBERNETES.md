...
WAY DECLARATIVE SERVICE FOR MYSQL
~~~
$ k get service mysql-db -o yaml > xdeploy/mysql/service-mysql.yaml
~~~
WAY DECLARATIVE DEPLOYMENT FOR USER MICROSERVICE 
forma 1
~~~
$ k get deployment msvc-usuarios -o yaml > xdeploy/users/deployment-usuarios.yaml
~~~
forma 2 -> con create
...
DECLARE SERVICE FOR USER MICROSERVICE
~~~
$ k get service msvc-usuarios -o yaml > xdeploy/users/service-usuarios.yaml
~~~

### 9. DELETING DEPLOYMENT OF WAY DECLARATIVE
~~~
$ k delete -f  ./xdeploy/users/deployment-usuarios.yaml
deployment.apps "msvc-usuarios" deleted
~~~
### 10. CREATING DEPLOYMENT OF WAY DECLARATIVE
~~~
$ k apply -f  ./xdeploy/users/deployment-usuarios.yaml
